package com.dashboard.swing.table;
...
public class Action extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdEdit = new com.dashboard.swing.Button();
        cmdDelete = new com.dashboard.swing.Button();

        cmdEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dashboard/icon/edit.png"))); // NOI18N

        cmdDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dashboard/icon/delete.png"))); // NOI18N
    ...
    private com.dashboard.swing.Button cmdDelete;
    private com.dashboard.swing.Button cmdEdit;

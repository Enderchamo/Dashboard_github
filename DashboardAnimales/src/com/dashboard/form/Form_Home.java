...
import com.dashboard.dialog.Message;
import com.dashboard.main.Main;
...
import com.dashboard.swing.noticeboard.ModelNoticeBoard;
...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initTableData() {
        ...
        table1.addRow(new ModelMascota(new ImageIcon(getClass().getResource("/com/dashboard/icon/profile3.jpg")), "Firulai", " Male", "Pastor",  true,   3,   12.0).toRowTable(eventAction));
    ...
    private void initNoticeBoard() {
        ...
        noticeBoard2.addDate("04/10/2021");
        noticeBoard2.addNoticeBoard(new ModelNoticeBoard(new Color(94, 49, 238), "Hidemode", "Now", "Sets the hide mode for the component. If the hide mode has been specified in the This hide mode can be overridden by the component constraint."));
        noticeBoard2.addNoticeBoard(new ModelNoticeBoard(new Color(218, 49, 238), "Tag", "2h ago", "Tags the component with metadata name that can be used by the layout engine. The tag can be used to explain for the layout manager what the components is showing, such as an OK or Cancel button."));
        noticeBoard2.addDate("03/10/2021");
        noticeBoard2.addNoticeBoard(new ModelNoticeBoard(new Color(32, 171, 43), "Further Reading", "12:30 PM", "There are more information to digest regarding MigLayout. The resources are all available at www.migcomponents.com"));
        noticeBoard2.addNoticeBoard(new ModelNoticeBoard(new Color(50, 93, 215), "Span", "10:30 AM", "Spans the current cell (merges) over a number of cells. Practically this means that this cell and the count number of cells will be treated as one cell and the component can use the space that all these cells have."));
        noticeBoard2.addNoticeBoard(new ModelNoticeBoard(new Color(27, 188, 204), "Skip ", "9:00 AM", "Skips a number of cells in the flow. This is used to jump over a number of cells before the next free cell is looked for. The skipping is done before this component is put in a cell and thus this cells is affected by it. \"count\" defaults to 1 if not specified."));
        noticeBoard2.addNoticeBoard(new ModelNoticeBoard(new Color(238, 46, 57), "Push", "7:15 AM", "Makes the row and/or column that the component is residing in grow with \"weight\". This can be used instead of having a \"grow\" keyword in the column/row constraints."));
        noticeBoard2.scrollToTop();
    }
    ...
    private void initComponents() {
        ...
        card1 = new com.dashboard.component.Card();
        jLabel1 = new javax.swing.JLabel();
        card2 = new com.dashboard.component.Card();
        card3 = new com.dashboard.component.Card();
        jPanel1 = new javax.swing.JPanel();
        noticeBoard = new com.dashboard.swing.noticeboard.NoticeBoard();
        ...
        table1 = new com.dashboard.swing.table.Table();
        jLabel6 = new javax.swing.JLabel();
        jPanel4 = new javax.swing.JPanel();
        noticeBoard2 = new com.dashboard.swing.noticeboard.NoticeBoard();
        jLabel10 = new javax.swing.JLabel();
        jLabel11 = new javax.swing.JLabel();
        jLabel12 = new javax.swing.JLabel();

        card1.setBackground(new java.awt.Color(204, 204, 0));
        card1.setColorGradient(new java.awt.Color(153, 0, 153));

        jLabel1.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setText("Dashboard / Home");

        card2.setBackground(new java.awt.Color(234, 103, 223));
        card2.setColorGradient(new java.awt.Color(72, 111, 252));

        card3.setBackground(new java.awt.Color(102, 255, 204));
        card3.setColorGradient(new java.awt.Color(255, 204, 0));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addComponent(noticeBoard, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE))
        );
        ...
        jLabel10.setText("Solicitudes recieantes");
        ...
        jLabel11.setText("Simple Miglayout API Doc");
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addComponent(noticeBoard2, javax.swing.GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE))
        );
    ...
    private com.dashboard.component.Card card1;
    private com.dashboard.component.Card card2;
    private com.dashboard.component.Card card3;
    ...
    private com.dashboard.swing.noticeboard.NoticeBoard noticeBoard;
    private com.dashboard.swing.noticeboard.NoticeBoard noticeBoard2;
    private com.dashboard.swing.table.Table table1;
